...
// Module
exports.push([module.i, ".bot-ui{position:fixed;z-index:1000;bottom:1.5rem;right:1.5rem;display:flex;flex-direction:column;font-size:1rem}.bot-ui *{box-sizing:border-box}.preload-image{position:absolute;top:0;left:0;width:0;height:0;overflow:hidden}.bot-ui--animate .fadeUp-enter-active,.bot-ui--animate .fadeUp-leave-active{opacity:1;transform:translate(0);transition:opacity .15s linear,transform .2s ease-out}.bot-ui--animate .fadeUp-enter,.bot-ui--animate .fadeUp-leave-to{transform:translateY(20px);opacity:0}.bot-ui--animate .scaleUp-enter-active,.bot-ui--animate .scaleUp-leave-active{opacity:1;transform:scale(1);transition:opacity .1s linear,transform .2s ease-out}.bot-ui--animate .scaleUp-enter,.bot-ui--animate .scaleUp-leave-to{transform:scale(0);opacity:0}@-webkit-keyframes qkbJump{0%{transform:translateY(2px)}to{transform:translateY(-1px)}}@keyframes qkbJump{0%{transform:translateY(2px)}to{transform:translateY(-1px)}}.msg-bubble__typing-indicator:after,.msg-bubble__typing-indicator:before,.msg-bubble__typing-indicator span{transform:translateY(2px);-webkit-animation:qkbJump .35s ease infinite alternate;animation:qkbJump .35s ease infinite alternate}.msg-bubble__typing-indicator span{-webkit-animation-delay:.175s;animation-delay:.175s}.msg-bubble__typing-indicator:after{-webkit-animation-delay:.35s;animation-delay:.35s}.bot-bubble{align-self:flex-end}.bubble-btn{display:block;padding:0;outline:0;border:0;box-shadow:none;border-radius:50%;color:#fff;fill:#fff;cursor:pointer;box-shadow:0 3px 5px 0 rgba(0,0,0,.15);transition:opacity .2s linear}.bubble-btn:hover{opacity:.85}.bubble-btn-icon{display:block;position:absolute;top:50%;left:50%;width:27px;height:auto;margin:-11px 0 0 -13px;line-height:1em}.bubble-btn-icon.bubble-btn-icon--close{width:15px;margin:-7px 0 0 -7px}.zone-chat{display:flex;flex-direction:column;position:absolute;right:0;overflow:hidden;width:376px;height:80vh;margin-bottom:10px;border-radius:8px;background-color:#fff;box-shadow:0 3px 30px 0 rgba(0,0,0,.15)}.zone-chat-header{display:flex;flex:none;align-items:center;justify-content:space-between;height:50px;padding:5px 15px}.zone-chat-header__title{font-weight:700;font-size:.875rem}.zone-chat-content{flex-grow:1;overflow:hidden scroll}.zone-chat-content__bubbles{min-height:100%;padding:1.5rem 1.25rem 1rem}.msg-bubble{display:flex;position:relative}.msg-avatar{flex-grow:1;flex:none;position:relative;overflow:hidden;border-radius:50%}.msg-avatar__img{position:absolute;top:0;left:0;width:100%;height:100%;background-color:transparent;background-size:cover;background-repeat:no-repeat}.msg-bubble__time{display:none;position:absolute;right:0;top:0;padding:2px 5px;margin-top:-5px;border-radius:5px;font-size:.625rem;color:#fff;background-color:#222;transform:translateY(-100%);opacity:0;transition:opacity .1s linear 1s}.msg-bubble--user .msg-bubble__time{display:block}.msg-bubble-component{font-size:.875rem}.msg-bubble-component:hover~.msg-bubble__time{opacity:.8}.msg-bubble{padding-bottom:1rem}.msg-bubble.msg-bubble--bot .msg-bubble-component{margin-right:2.5rem;margin-left:.5rem}.msg-bubble.msg-bubble--user{justify-content:flex-end}.msg-bubble.msg-bubble--user .msg-bubble-component{margin-left:5rem}.msg-bubble-component__text{position:relative;padding:.75rem 1rem;border-radius:6px}.msg-bubble-component__options-wrapper{display:flex;flex-wrap:wrap}.mb-button-options__item{flex:0 0 auto}.mb-button-options__btn{display:block;overflow:hidden;position:relative;margin:.5rem .375rem 0 0;padding:.25rem 1rem;cursor:pointer;outline:0;border:1px solid transparent;border-radius:13px;color:inherit;font-size:.875rem;font-family:inherit;text-decoration:none;background-color:transparent;transition:background-color .15s linear,color .1s linear}.mb-button-options__btn span{position:relative;z-index:10}.msg-bubble__typing-indicator{position:relative;min-width:29px;opacity:.3}.msg-bubble__typing-indicator span{display:block;width:7px;height:7px;margin:0 auto;border-radius:50%}.msg-bubble__typing-indicator:after,.msg-bubble__typing-indicator:before{content:\"\";display:block;position:absolute;top:0;width:7px;height:7px;border-radius:50%}.msg-bubble__typing-indicator:before{left:0}.msg-bubble__typing-indicator:after{right:0}.zone-chat-action{position:relative;display:flex;flex:none;height:46px;padding:.45rem 1.25rem .5rem;border-top:1px solid #e6e6e6}.zone-chat-action--disabled:before{content:\"\";display:block;position:absolute;z-index:10;top:0;left:0;width:100%;height:100%;opacity:.2;cursor:not-allowed}.zone-chat-action__wrapper{display:flex;width:100%;background-color:#fff}.zone-chat-action__msg-box{position:relative;flex-grow:1;padding:0 1rem 0 0}.zone-chat-action__input{height:100%;width:100%;padding:0;font-size:.875rem;border:0;background-color:transparent;box-shadow:none;outline:0}.zone-chat-action__input[disabled=disabled]{pointer-events:none}.zone-chat-action__disable-text{display:flex;align-items:center;position:absolute;top:0;left:0;height:100%;width:100%;background-color:#fff;font-size:.875rem}.zone-chat-action__extra{display:flex;flex:none;justify-content:center}.action-item{display:block;padding:0;outline:0;border:0;line-height:1;box-shadow:none;background-color:transparent;cursor:pointer;opacity:.6;transition:opacity .1s linear}.action-item:hover{opacity:1}.action-icon{width:16px;height:16px;line-height:1;fill:#666;color:#666;vertical-align:middle}.zone-chat-aciton--typing .action-item--send{opacity:1}", ""]);
// Exports
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"bot-ui",class:_vm.uiClasses},[_c('transition',{attrs:{"name":"fadeUp"}},[(_vm.botActive)?_c('div',{staticClass:"zone-chat"},[_c('BoardHeader',{attrs:{"bot-title":_vm.optionsMain.botTitle},on:{"close-bot":_vm.botToggle}}),_c('BoardContent',{attrs:{"bot-typing":_vm.botTyping,"main-data":_vm.messages}}),_c('BoardAction',{attrs:{"input-disable":_vm.inputDisable,"input-placeholder":_vm.optionsMain.inputPlaceholder,"input-disable-placeholder":_vm.optionsMain.inputDisablePlaceholder},on:{"msg-send":_vm.sendMessage}})],1):_vm._e()]),_c('div',{staticClass:"bot-bubble"},[_c('button',{staticClass:"bubble-btn",on:{"click":_vm.botToggle}},[_vm._t("bubbleButton",[_c('transition',{attrs:{"name":"scaleUp"}},[(!_vm.botActive)?_c('BubbleIcon',{key:"1",staticClass:"bubble-btn-icon"}):_c('CloseIcon',{key:"2",staticClass:"bubble-btn-icon bubble-btn-icon--close"})],1)])],2)]),_c('AppStyle',{attrs:{"options":_vm.optionsMain}}),_c('div',{staticClass:"preload-image"},[(_vm.optionsMain.botAvatarImg)?_c('div',{staticClass:"msg-avatar__img"}):_vm._e()])],1)}
var staticRenderFns = []
...
var Headervue_type_template_id_b70ffcbe_lang_pug_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"zone-chat-header"},[_vm._t("header",[_c('div',{staticClass:"zone-chat-header__title"},[_vm._v(_vm._s(_vm.botTitle))])])],2)}
...
var Contentvue_type_template_id_cb3a621a_lang_pug_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"boardContent",staticClass:"zone-chat-content"},[_c('div',{ref:"boardBubbles",staticClass:"zone-chat-content__bubbles"},[_vm._l((_vm.mainData),function(item,index){return _c('message-bubble',{key:index,attrs:{"message":item}})}),(_vm.botTyping)?_c('div',{staticClass:"zone-chat-content__bot-typing"},[_vm._t("botTyping",[_c('message-typing')])],2):_vm._e()],2)])}
...
var SingleTextvue_type_template_id_0f53937a_lang_pug_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"msg-bubble-component msg-bubble-component--single-text"},[_c('div',{staticClass:"msg-bubble-component__text"},[_vm._v(_vm._s(_vm.mainData.text))])])}
...
var ButtonOptionsvue_type_template_id_28e65909_lang_pug_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"msg-bubble-component msg-bubble-component--button-options"},[_c('div',{staticClass:"msg-bubble-component__text"},[_vm._v(_vm._s(_vm.mainData.text))]),_c('div',{staticClass:"msg-bubble-component__options-wrapper"},_vm._l((_vm.mainData.options),function(item,index){return _c('div',{key:index,staticClass:"mb-button-options__item",class:{ active: _vm.selectedItem === item.value }},[(item.action === 'postback')?_c('button',{staticClass:"mb-button-options__btn",on:{"click":function($event){return _vm.selectOption(item)}}},[_c('span',[_vm._v(_vm._s(item.text))])]):_c('a',{staticClass:"mb-button-options__btn mb-button-options__url",attrs:{"target":"_blank","href":item.value}},[_c('span',[_vm._v(_vm._s(item.text))])])])}),0)])}
...
/* harmony default export */ var Mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    bubbleClass: function bubbleClass() {
      return this.message.agent === 'bot' ? 'msg-bubble--bot' : 'msg-bubble--user';
    },
...
var Typingvue_type_template_id_7757c674_lang_pug_staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"msg-bubble msg-bubble--bot"},[_c('div',{staticClass:"msg-avatar"},[_c('div',{staticClass:"msg-avatar__img"})]),_c('div',{staticClass:"msg-bubble-component msg-bubble-component--typing"},[_c('div',{staticClass:"msg-bubble-component__text"},[_c('div',{staticClass:"msg-bubble__typing-indicator"},[_c('span')])])])])}]
...
var Actionvue_type_template_id_de0d164e_lang_pug_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"zone-chat-action",class:_vm.actionClass},[_c('div',{staticClass:"zone-chat-action__wrapper"},[_c('div',{staticClass:"zone-chat-action__msg-box"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.messageText),expression:"messageText"}],ref:"qkbMessageInput",staticClass:"zone-chat-action__input",attrs:{"type":"text","disabled":_vm.inputDisable,"placeholder":_vm.inputPlaceholder},domProps:{"value":(_vm.messageText)},on:{"keydown":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.sendMessage($event)},"input":function($event){if($event.target.composing){ return; }_vm.messageText=$event.target.value}}}),(_vm.inputDisablePlaceholder && _vm.inputDisable)?_c('div',{staticClass:"zone-chat-action__disable-text"},[_c('span',[_vm._v(_vm._s(_vm.inputDisablePlaceholder))])]):_vm._e()]),_c('div',{staticClass:"zone-chat-action__extra"},[_vm._t("actions"),_c('button',{staticClass:"action-item action-item--send",on:{"click":_vm.sendMessage}},[_vm._t("sendButton",[_c('IconSend',{staticClass:"action-icon action-icon--send"})])],2)],2)])])}
...
var AppStylevue_type_template_id_168c7d68_lang_pug_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"bot-style",staticStyle:{"display":"none"},domProps:{"innerHTML":_vm._s(_vm.style)}})}
